/*insuranceapp.js
This has now been modified to include event listeners to help a user
enter data.

Based on Example in Dietel et al Chapter 13

*/
window.onload=initfunction;

var helpfulhints=["Please enter your last name","Please enter your first name","Enter your street address including City", " Enter your Postal Code", ""];

var displayhints;
/*
initfunction will be called when the page loads. This will 'load' the eventlisteners. This function calls createListeners. I took the example from the text. I thought it was more 'elegant' than hard coding all the listeners
*/
